const Forum = require("../BED/models/forum");
...
describe("Forum Model", () => {
    ...
    describe("getForumByTitle", () => {
        it("should return forums with matching title", async () => {
                ...
                recordset: [
                    {
                        ...
                        title: "Test Forum",
                        author: "Test Author",
                        comments: "This is a test forum.",
                    },
                    {
                        forumId: 2,
                        title: "Test Forum 2",
                        author: "Another Author",
                        comments: "Another test forum.",
                    },
                ],
            };
            ...
            //const forums = await Forum.getForumByTitle(mockTitle);
    ...
    describe("createForum", () => {
        ...
        it("should handle errors during forum creation", async () => {
            ...
            //await expect(Forum.createForum(title, author, comments)).rejects.toThrow(errorMessage);
    ...
    describe("updateForum", () => {
        it("should update a forum successfully", async () => {
            ...
            //const updatedForum = await Forum.updateForum(forumId, title, author, comments);
        ...
        it("should handle errors during forum update", async () => {
            ...
            //await expect(Forum.updateForum(forumId, title, author, comments)).rejects.toThrow(errorMessage);
    ...
    describe("deleteForum", () => {
        it("should delete a forum successfully", async () => {
            ...
            const result = await Forum.deleteForum(forumId);
        ...
        it("should handle errors during forum deletion", async () => {
            ...
            //await expect(Forum.deleteForum(forumId)).rejects.toThrow(errorMessage);
